...
const AdminEditProducts = () => {
    ...
    const [CatID, BrandID, onChangeDesName, onChangeQty, onChangeColor, onChangePriceAfter, onChangePriceBefore, 
        ...
        colors, priceBefore, qty, prodDescription, prodName] = AdminEditProductsHook(id);
