...
const RateItem = ({ review }) => {
    ...
    const [showEdit, handleCloseEdit, handleShowEdit, handleEdit, onChangeRateText, newRateText, 
        OnChangeRateValue, newRateValue] = EditRateHook(review)
        ...
        <div>
            ...
            <Row className="mt-3">
                <Col className="d-flex me-5">
                    ...
                    <div className="cat-rate d-inline p-1 pt-0">{review.rating}</div>
                </Col>
            </Row>
